...
# setting
model_name = 'CCLNet_mimic-iii'
resume_path = 'saved/{}/cclnet_mimic3.model'.format(model_name)
...
def main():
    ...
    model = CCLNet(args, sym_information, ddi_adj, input_smiles_init_rep, emb_dim=args.dim, device=device)
    print(model)
